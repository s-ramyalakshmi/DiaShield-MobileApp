package com.example.mydiashield;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        butn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(heartRateProcIsRunningg == true) {
                    ...
                    System.gc();
                    Intent inte = new Intent(MainActivity.this, HeartRateCalcService.class);
                    startService(inte);
        ...
        //respiratory rate measuring button
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    try {
                        ...
                        db.execSQL("create table "+ TableName +" (" + " recID integer PRIMARY KEY autoincrement, " + " heart_rate real, "
                                + " respiratory_rate real, " + " Nausea real, " + " Headache real, " + " Diarrhea real, "
                                + " Soar_throat real, " + " Fever real, " + " Muscle_Ache real, " + " Loss_of_smell_or_taste real, " + " cough real, " + " shortness_of_breath real, " + " Feeling_tired real ); " );
    ...
    public void addRespiratoryHeartData(Float heartData, Float respData){
        ...
        db.beginTransaction();
        try {
            db.execSQL( "insert into "+TableName+" (heart_rate, respiratory_rate) values ('"+heartData+"', '"+respData+"' );" );
            db.setTransactionSuccessful();
        }
        catch (SQLiteException e) {
